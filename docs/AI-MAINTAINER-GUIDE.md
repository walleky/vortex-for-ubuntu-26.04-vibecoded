...
- Provides `last-log` for the newest SKSE/preflight launch log under `~/.local/share/proton-vortex/logs`
...
- If a desktop launch fails silently, inspect `proton-vortex-skyrim-se last-log`
